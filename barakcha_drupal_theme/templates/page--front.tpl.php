...
<!-- Верстка выпадающего меню -->
         ...
         <?php 
			$block = block_load('menu', 'menu-lenta-menu');
...
?>
         ...
         <div><!-- lenta_follow_nauka begins-->
         <span>Lenta politika</span>
	      <?php print views_embed_view('lenta_follow_politika'); ?>
         </div><!-- lenta_follow_nauka ends-->
   
       
         <div><!-- lenta_follow_nauka begins-->
         <span>Lenta nauka</span>
	      <?php print views_embed_view('lenta_follow_nauka'); ?>
         </div><!-- lenta_follow_nauka ends-->
             <p>callbacks</p>
           <?php dpm($callbacks); ?>
