...
<!-- Верстка выпадающего меню -->
            ...
            ?>
             ...
             ?>
				...
				</div> <!-- login/logout forms end -->
				</div> <!-- content ends -->
			<div id="second_sidebar">
				<div class="reklama left">
					<div class="_header left"><img class="left" src="<?php global $base_path; print $base_path.path_to_theme(); ?>/images/reklama.png"/><a class="left" href="">Реклама</a></div>
					<div class="_item">
