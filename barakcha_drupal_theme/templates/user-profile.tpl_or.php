...
<div>
	<span>tape follow view</span>
   <?php print views_embed_view('follow_tape'); ?>
</div>
...
<div>
	<?php 	
      print views_embed_view('otsenki_politika'); 
	?>
</div>

<div>
	<?php 	
      print views_embed_view('otsenki_filosofija'); 
	?>
</div>
...
<div>
   <?php 	
      print views_embed_view('politika'); 
	?>
</div>

<div>
	<?php 	
      print views_embed_view('pravo'); 
	?>
</div>

<div>
	<?php 	
      print views_embed_view('ekonomika'); 
	?>
</div>

<div>
	<?php 	
      print views_embed_view('filosofija'); 
	?>
</div>
...
<div>
	<?php 	
      print views_embed_view('statji_pravo'); 
	?>
</div>

<div>
	<?php 	
print views_embed_view('statji_filosofija'); 
	 ?>
</div>

<div>
	<?php 	
      print views_embed_view('statji_ekonomika'); 
	?>
</div>

<div>
	<?php 	
      print views_embed_view('statji_politika'); 
	?>
</div>
